...
def test_all_screens_importable():
    ...
    screens = [
        BandwidthSelectScreen, ConfigScreen, ConfirmScreen, EditMachineScreen,
        LaunchScreen, MapsScreen, MonitorScreen, PriorMapSelector,
        TransferScreen, VerifyScreen, ZenohScreen,
    ]
    for s in screens:
