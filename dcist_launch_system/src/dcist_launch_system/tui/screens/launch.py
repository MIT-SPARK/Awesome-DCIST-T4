...
# Path to autogenerated tmux session files
# screens/ is 5 levels deep from the dcist_launch_system root:
# src/dcist_launch_system/tui/screens/launch.py → ../../../../.. = dcist_launch_system/
_TMUX_DIR = pathlib.Path(__file__).resolve().parents[4] / "tmux" / "autogenerated"
