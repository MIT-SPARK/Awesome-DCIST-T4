...
class Example1NodeMonitor:
    ...
    def callback(self, msg):
        ...
        info = NodeInfo(nickname="example1", node_name="<external monitor>", status=status, notes=note)

        self.monitor.update_node_info(info)


@register_config("external_monitor", name="Example1NodeMonitor", constructor=Example1NodeMonitor)
@dataclass
