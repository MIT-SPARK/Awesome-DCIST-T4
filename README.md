...
What session do you want to load? [1]: 7
[Loading] /home/nathan/dcist_ws/src/awesome_dcist_t4/dcist_launch_system/tmux/autogenerated/spot_prior_dsg-spot_prior_dsg.yaml
```

`run-adt4` will use environment variables `ADT4_ROBOT_NAME` and `ADT4_OUTPUT_DIR` if they are specified instead of prompting you for inputs (you can also specify both by command line arg).
